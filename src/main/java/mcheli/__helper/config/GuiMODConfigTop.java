...
extends GuiScreen {
    ...
    public void func_73866_w_() {
        ...
        this.func_189646_b((GuiButton)new GuiButtonExt(1, this.field_146294_l - 20 - doneWidth, this.field_146295_m - 29, doneWidth, 20, doneText));
        ...
        GuiButtonExt assistBtn = new GuiButtonExt(16, this.field_146294_l / 2 - 100, 64, 200, 20, I18n.func_135052_a((String)"gui.mcheli.generateLegacyAsisst", (Object[])new Object[0]));
        this.func_189646_b((GuiButton)configBtn);
        this.func_189646_b((GuiButton)assistBtn);
        this.assistHoverChecker = new HoverChecker((GuiButton)assistBtn, 800);
    }

    public void func_73863_a(int mouseX, int mouseY, float partialTicks) {
        this.func_146276_q_();
        this.func_73732_a(this.field_146289_q, "MC Helicopter MOD Config", this.field_146294_l / 2, 8, 0xFFFFFF);
        if (this.genAnimationTicks > 0) {
            float f = this.genAnimationTicks > 10 ? 1.0f : (float)this.genAnimationTicks / 10.0f;
            this.func_73731_b(this.field_146289_q, "Generate Done!", this.field_146294_l / 2 - 100, 92, 0xFF2222 | (int)(255.0f * f) << 24);
        }
        super.func_73863_a(mouseX, mouseY, partialTicks);
        if (this.assistHoverChecker.checkHover(mouseX, mouseY)) {
            this.drawToolTip(Arrays.asList(I18n.func_135052_a((String)"gui.mcheli.generateLegacyAsisst.desc", (Object[])new Object[0]).split("\n")), mouseX, mouseY);
        }
    }
    ...
    private void drawToolTip(List<String> stringList, int x, int y) {
        GuiUtils.drawHoveringText(stringList, (int)x, (int)y, (int)this.field_146294_l, (int)this.field_146295_m, (int)300, (FontRenderer)this.field_146289_q);
    }
}
