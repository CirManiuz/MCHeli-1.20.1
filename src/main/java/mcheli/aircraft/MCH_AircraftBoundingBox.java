...
extends AxisAlignedBB {
    ...
    public double getDistSq(AxisAlignedBB a1, AxisAlignedBB a2) {
        double x1 = (a1.field_72336_d + a1.field_72340_a) / 2.0;
        double y1 = (a1.field_72337_e + a1.field_72338_b) / 2.0;
        double z1 = (a1.field_72334_f + a1.field_72339_c) / 2.0;
        double x2 = (a2.field_72336_d + a2.field_72340_a) / 2.0;
        double y2 = (a2.field_72337_e + a2.field_72338_b) / 2.0;
        double z2 = (a2.field_72334_f + a2.field_72339_c) / 2.0;
        double dx = x1 - x2;
        double dy = y1 - y2;
        double dz = z1 - z2;
    ...
    public boolean func_72326_a(AxisAlignedBB aabb) {
        ...
        for (MCH_BoundingBox bb : this.ac.extraBoundingBox) {
            if (!bb.getBoundingBox().func_72326_a(aabb)) continue;
    ...
    public RayTraceResult func_72327_a(Vec3d v1, Vec3d v2) {
        ...
        for (MCH_BoundingBox bb : this.ac.extraBoundingBox) {
            ...
            if (mop2 == null || !((dist2 = v1.func_72438_d(mop2.field_72307_f)) < dist)) continue;
            mop = mop2;
            dist = dist2;
            this.ac.lastBBDamageFactor = bb.damegeFactor;
        }
