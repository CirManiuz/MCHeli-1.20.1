...
extends MCH_GuiScoreboard_Base {
    ...
    public void func_73866_w_() {
        super.func_73866_w_();
        W_ScaledResolution sr = new W_ScaledResolution(this.field_146297_k, this.field_146297_k.field_71443_c, this.field_146297_k.field_71440_d);
    ...
    protected void func_146284_a(GuiButton btn) throws IOException {
        if (btn != null && btn.field_146124_l) {
            switch (btn.field_146127_k) {
                ...
                case 576: {
                    ++this.lastTeamColor;
                    if (this.lastTeamColor < colorNames.length) break;
                    this.lastTeamColor = 0;
                    break;
                }
                case 577: {
                    --this.lastTeamColor;
                    if (this.lastTeamColor >= 0) break;
    ...
    protected void func_146976_a(float par1, int par2, int par3) {
        MCH_GuiScoreboard_CreateTeam.drawList(this.field_146297_k, this.field_146289_q, true);
        W_ScaledResolution sr = new W_ScaledResolution(this.field_146297_k, this.field_146297_k.field_71443_c, this.field_146297_k.field_71440_d);
        int factor = sr.func_78325_e() > 0 ? sr.func_78325_e() : 1;
        ...
        TextFormatting ecf = TextFormatting.func_96300_b((String)colorNames[this.lastTeamColor]);
